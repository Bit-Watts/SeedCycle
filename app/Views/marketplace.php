        ...
        <div class="sc-market-card"
          ...
          <div class="sc-market-info">
            ...
            <?php if (!empty($seed['seller_id'])): ?>
              <?php $sellerUrl = (isset($_SESSION['user_id']) && (int)$_SESSION['user_id'] === (int)$seed['seller_id']) ? 'profile.php' : 'seller-profile.php?id=' . $seed['seller_id']; ?>
              <a href="<?= $sellerUrl ?>" class="sc-market-seller">
