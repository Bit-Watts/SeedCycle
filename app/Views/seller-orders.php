...
<div class="sc-dashboard">
  ...
  <main class="sc-main">
    ...
    <div class="sc-main-header">
      ...
      <a href="manage-shipments.php" class="sc-btn-manage-shipments">
        <i class="fa-solid fa-truck-fast"></i> Manage Shipments
      </a>
    </div>
...
function generateTracking() {
  const prefix = ['SC', 'TRK', 'SHD', 'PKG'][Math.floor(Math.random() * 4)];
  const num = Math.floor(100000000 + Math.random() * 900000000);
  document.getElementById('createTrackingNumber').value = prefix + num;
}
